...
function readShell(){
  ...
  catch(e){ return '<div id="loginScreen" class="login-screen premium-login"><form id="loginForm" class="login-card premium-login-card"><h2>Acessar central</h2><p>Entre com suas credenciais para acessar a plataforma <b>Tosi Support Pro</b>.</p><label>E-mail corporativo</label><div class="secure-input"><span>✉</span><input id="loginEmail" type="email" autocomplete="username" placeholder="Digite seu e-mail"></div><label>Senha</label><div class="secure-input"><span>🔒</span><input id="loginPassword" type="password" autocomplete="current-password" placeholder="Digite sua senha"></div><button class="primary login-submit">↪ Entrar</button></form></div><div id="app" class="app hidden"><aside class="sidebar"><nav id="nav"></nav></aside><main class="main"><header class="topbar"><h2 id="pageTitle">Dashboard</h2><p id="pageSubtitle"></p></header><section id="dashboard" class="page active-page"></section></main></div>'; }
}
